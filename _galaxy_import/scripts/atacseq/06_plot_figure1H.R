...
output_dir <- file.path("results", "atacseq", "figure1")
...
cfg_bw <- data.table(
  ...
  file = path.expand(c(
    "~/projects/keke/female_inf/UF.pooled.bigWig",
    "~/projects/keke/female_inf/IF.pooled.bigWig",
    "~/projects/keke/male_inf/UNINF.pooled.bigWig",
    "~/projects/keke/male_inf/INF.pooled.bigWig"
  ))
)

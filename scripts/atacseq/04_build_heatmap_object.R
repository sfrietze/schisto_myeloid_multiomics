...
bw_files <- list(
  UF_fem_inf  = file.path(BIGWIG_DIR, "UF.pooled.bigWig"),
  IF_fem_inf  = file.path(BIGWIG_DIR, "IF.pooled.bigWig"),
  UF_male_inf = file.path(BIGWIG_DIR, "UNINF.pooled.bigWig"),
  IF_male_inf = file.path(BIGWIG_DIR, "INF.pooled.bigWig")
)
